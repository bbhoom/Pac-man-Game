...
for i in range(1, 5):
    player_images.append(pygame.transform.scale(
        pygame.image.load(f'player_images/{i}.png'), (35, 35)))

blinky_img = pygame.transform.scale(
    pygame.image.load(f'red.png'), (35, 35))
pinky_img = pygame.transform.scale(
    pygame.image.load(f'pink.png'), (35, 35))
inky_img = pygame.transform.scale(pygame.image.load(f'blue.png'), (35, 35))
clyde_img = pygame.transform.scale(
    pygame.image.load(f'orange.png'), (35, 35))
spooked_img = pygame.transform.scale(
    pygame.image.load(f'powerup.png'), (35, 35))
dead_img = pygame.transform.scale(
    pygame.image.load(f'dead.png'), (35, 35))
...
class Ghost:
    ...
    def draw(self):
        ...
        ghost_rect = pygame.rect.Rect(
            (self.center_x - 17, self.center_y - 17), (30, 30))
        return ghost_rect
    ...
    def check_collisions(self):
        ...
        if 0 < self.center_x//30 < 29:
            ...
            self.turns[0] = True
            self.turns[1] = True
        # check if ghost is in box or no
        if 255 < self.x_pos < 416 and 274 < self.y_pos < 357:
            self.in_box = True
        else:
            self.in_box = False
...
def draw_misc():
    ...
    screen.blit(text, (10, 710))
    if powerup:
        pygame.draw.circle(screen, 'blue', (130, 717), 10)
    for i in range(lives):
        screen.blit(pygame.transform.scale(
            player_images[0], (25, 25)), (520+i*40, 700))
    if game_over:
        pygame.draw.rect(screen, "white", [50, 200, 600, 300], 0, 10)
        pygame.draw.rect(screen, "dark grey", [70, 220, 560, 260], 0, 10)
    ...
    if game_won:
        ...
        pygame.draw.rect(screen, 'dark grey', [70, 220, 560, 260], 0, 10)
        gameover_text = font.render(
            'Victooryy! Space bar to restart!', True, 'green')
        screen.blit(gameover_text, (100, 300))
...
while run:
    ...
    player_circle = pygame.draw.circle(
        screen, 'black', (center_x, center_y), 17, 2)
    draw_player()

    blinky = Ghost(blinky_x, blinky_y, targets[0], ghost_speeds[0],
